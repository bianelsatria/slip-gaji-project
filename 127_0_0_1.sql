...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 15, 2026 at 08:14 AM
...
('root', '[{\"db\":\"slip_gaji_db\",\"table\":\"users\"}]');
...
('root', '2026-09-14 15:34:01', '{\"Console\\/Mode\":\"show\"}');
...
--
CREATE DATABASE IF NOT EXISTS `slip_gaji_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `slip_gaji_db`;
...
('R70PuprGraCL92E6gRVU3Q5IeHJU6MVeKOUxMCbO', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '', 1789449009);
